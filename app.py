...
with tab_custom:
    ...
    if not df_custom.empty:
        ...
        st.info(f"No snapshot data recorded for {selected_slot_label} yet. Keep Streamlit running during market hours to log snapshots.")
